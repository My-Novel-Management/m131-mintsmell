...
def first_kiss(w: World):
    ...
    return w.scene('はじめてのキス',
            ...
            na.do("駅前で偶然$minaと出くわした",
                ...
                "大人の事情も家庭の事情もよく分からなかったけれど、来年にはこの町を離れて東京で暮らすのだと話してくれた",
                "結婚相手はずっと前に決まっていて「いい人なのよ」と付け合せのように口にする"),
            ...
            na.do("子どもにとってキスなんて想像でもどうするかよく分かっていなかったりして、",
                "それも初めて経験するものがただ唇と唇を触れ合わせるだけの遊びのようなそれとは異なり、欲望のままに弄るような粘膜の接触だったなんて、",
                "甘酸っぱい思い出とはとても呼べるものではなく、トラウマと言ってしまっていいくらいの衝撃的な出来事だった"),
            na.do("とても長い時間されるがままになっていた気がするけれど、実際には数十秒程度だったのだと思う",
                "キスが終わっても雨は弱まらず、それから二人は無言でバスを待ち続けた"),
            w.br(),
            w.plot_note("それから一週間後にお姉さんは自殺した"),
            na.explain("その一週間後、$minaさんは自殺をした"),
