...
def the_summer_truth(w: World):
    ...
    return w.scene("あの夏の真実",
            ...
            na.think("月に二、三度という頻度でここを利用して、$minaは$Sに自分が買った女物の服を着せては「かわいい」と喜んだ",
            ...
            na.think("それは二人だけの秘密で、彼女はここだけで普段は見せないような大きな口を開けて笑ったり、嫌いなことや苦手なもの、",
                "親に対しての愚痴も平気で言葉にした",
            ...
            na.think("それから一週間後に、$minaはこの世界から去った"),
            )
